...
namespace aSIMS.Models
{
    public class TeacherModel : BaseModel<TeacherModel>
    {
        ...
        [Required]
        [Display(Name = "TeacherName", ResourceType = typeof(LabelNaming))]
        ...
        [Required]
        [Display(Name = "Qualification", ResourceType = typeof(LabelNaming))]
        ...
        //Roles LIST
        public IEnumerable<BasicModel> GroupSections { get; set; }
        public IEnumerable<SelectListItem> GroupSectionList { get; set; }
        private int _groupSectionID = 0;
        [Required]
        [Display(Name = "GroupSectionID", ResourceType = typeof(LabelNaming))]
        public int GroupSectionID
        {
            get { return _groupSectionID; }
            set { _groupSectionID = value; }
        }
